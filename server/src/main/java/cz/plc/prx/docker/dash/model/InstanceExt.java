...
public class InstanceExt extends Instance {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(hostnamePath, domainName, user, exposedPorts, volumes, tty, openStdin, stdinOnce, env, cmd, argsEscaped, image, workingDir, entrypoint, onBuild, labels, super.hashCode());
    }
